    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_to', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='send_to', to='unhindled.author')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('pn', 'Pending'), ('ac', 'Accepted')], default=('pn', 'Pending'), max_length=4)),
            ],
            options={
