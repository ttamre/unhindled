...
urlpatterns = [
    ...
    path('service/author/<str:id>/posts/<str:post_id>/comments', views.CommentViewSet.as_view({'get':'list', 'post':'postComment'})),
    path('service/author/<str:id>/posts/<str:post_id>/likes', views.LikeViewSet.as_view({'get':'postList', 'post':'likePost'})),
    path('service/author/<str:user_id>/posts/<str:post_id>/comments/<str:comment_id>/likes', views.LikeViewSet.as_view({'get':'commentList', 'post':'likeComment'})),
